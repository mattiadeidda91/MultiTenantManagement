...
namespace MultiTenantManagement.Dependencies.Services
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailAsync(string subject, string body, List<string> toEmails, List<string>? ccEmails = null, List<string>? bccEmails = null)
        {
            ...
            using var serverSmtp = new SmtpClient
            {
